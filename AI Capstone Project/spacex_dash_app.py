...
# Assuming spacex_df is your DataFrame with launch site names
launch_site_names = spacex_df['Launch Site'].unique()

# Creating options for the dropdown including 'All Sites'
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    marks={value: str(value) for value in list(range(0,11000,1000))},  # Tick marks with corresponding labels
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, names='class', title=f'Success and Failure Launches for {entered_site}')
